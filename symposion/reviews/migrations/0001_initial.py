...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vote', models.CharField(blank=True, choices=[('++', '++ : Good proposal and I will argue for it to be accepted.'), ('+', '+ : OK proposal, but I will not argue for it to be accepted.'), ('-', '− : Weak proposal, but I will not argue strongly against acceptance.'), ('--', '−- : Serious issues and I will argue to reject this proposal.'), ('0', 'Abstain : I do not want to review this proposal and I do not want to see it again.')], max_length=2, verbose_name='Vote')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strong_accept', models.PositiveIntegerField(default=0, verbose_name='Strong accept')),
                ('weak_accept', models.PositiveIntegerField(default=0, verbose_name='Weak accept')),
                ('weak_reject', models.PositiveIntegerField(default=0, verbose_name='Weak reject')),
                ('strong_reject', models.PositiveIntegerField(default=0, verbose_name='Strong reject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vote', models.CharField(choices=[('++', '++ : Good proposal and I will argue for it to be accepted.'), ('+', '+ : OK proposal, but I will not argue for it to be accepted.'), ('-', '− : Weak proposal, but I will not argue strongly against acceptance.'), ('--', '−- : Serious issues and I will argue to reject this proposal.'), ('0', 'Abstain : I do not want to review this proposal and I do not want to see it again.')], max_length=2, verbose_name='Vote')),
                ('submitted_at', models.DateTimeField(default=datetime.datetime.now, editable=False, verbose_name='Submitted at')),
