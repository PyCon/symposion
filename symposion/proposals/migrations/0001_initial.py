    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='If your proposal is accepted this will be made public and printed in the program. Should be one paragraph, maximum 400 characters.', max_length=400, verbose_name='Brief Description')),
                ('abstract', models.TextField(blank=True, help_text="Detailed outline. Will be made public if your proposal is accepted. Edit using <a href='http://daringfireball.net/projects/markdown/basics' target='_blank'>Markdown</a>.", verbose_name='Detailed Abstract')),
                ...
                ('additional_speakers', models.ManyToManyField(blank=True, through='symposion_proposals.AdditionalSpeaker', to='symposion_speakers.SpeakerBase', verbose_name='Addtional speakers')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anonymous', models.BooleanField(default=False, help_text='If this option is switched on, reviewers will not be able to see the names of the proposers or coproposers of any proposal in this section.', verbose_name='Anonymous review')),
        ...
        migrations.AddField(
            model_name='proposalbase',
            name='speaker',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proposals', to='symposion_speakers.SpeakerBase', verbose_name='Speaker'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='additionalspeaker',
            name='speaker',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='symposion_speakers.SpeakerBase', verbose_name='Speaker'),
        ),
